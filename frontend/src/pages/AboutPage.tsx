    ...
    <div style={{ padding: '3rem 2rem', maxWidth: '900px', margin: '0 auto' }}>
      ...
      <div style={{ color: '#555', fontSize: '1.1rem', lineHeight: '1.8' }}>
        ...
        <p style={{ marginBottom: '1.5rem' }}>
          ...
          as Sor or Giuliani. This gives power back to performers to discover and choose based on the 
          music itself, not what's trending or what the algorithm thinks you should hear.
        </p>
        <p style={{ marginBottom: '1.5rem' }}>
          Solmu is an attempt to preserve the full scope of classical guitar repertoire and make it 
          accessible to anyone looking for their next piece.
        </p>
      </div>
    </div>
  );
